					...
					<div class="row-fluid">
						...
						<div class="row-fluid">
								<div class="btn-toolbar">
									<a href="<?=site_url("/project_new/project_new")?>"><button class="btn btn-primary" id="new_people"><i class="icon-plus"></i>新增</button></a>
								</div>
							<form action="http://120.119.77.23/dysarthria-scale-php/index.php/projectview_admin" method="post">
								<div class="well">
