											...
											<td>
												...
												?>
														<select id="Score_value" name="Score_value[]">
															<option value="1=./uploads/<?php echo $wav_name[$i][$j];?>=<?=base_url("/uploads/".$wav_name[$i][$j])?>" selected="selected">清晰</option>
															<option value="0=./uploads/<?php echo $wav_name[$i][$j];?>=<?=base_url("/uploads/".$wav_name[$i][$j])?>">不清晰</option>
														</select>
												<?php
													}
													else
												...
												?>
														<select id="Score_value" name="Score_value[]">
															<option value="0=./uploads/<?php echo $wav_name[$i][$j];?>=<?=base_url("/uploads/".$wav_name[$i][$j])?>" selected="selected">不清晰</option>
															<option value="1=./uploads/<?php echo $wav_name[$i][$j];?>=<?=base_url("/uploads/".$wav_name[$i][$j])?>">清晰</option>
														</select>
												<?php
													}
												}
