		...
		<body> 
			...
			<div class="content">
				...
				<div class="header">
					...
					<h1 class="page-title">檢視類別(王大明)</h1>
				</div>
						...
						<div class="well" style="border: 0px;">
										<table class="sortable table">
											...
											<tbody> 
												<tr>
													<td>
														<a href="<?=base_url("/projectview_admin/subjects_view_glossary")?>">字彙<img src="Storytelling.jpg" width="300" height="200"></a>
													</td>
												</tr>
												<tr>
													<td>
