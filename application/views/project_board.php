				...
				<div class="container-fluid">
					<div class="row-fluid">
						...
						<div class="btn-toolbar">
							<button class="btn btn-primary" id="test" disabled="disabled" onclick="javascript:location.href='http://localhost/dysarthria-scale-php(1)/dispatch.php'">派遣</button>
							<button class="btn btn-primary" id="new_people" onclick="javascript:location.href='http://localhost/dysarthria-scale-php(1)/additional.php'"><i class="icon-plus"></i>新增</button>
						</div>
						<div class="well" >
							<ul class="nav nav-tabs" style="margin-bottom: 0px;">
								<li class="active"><a href="#chit" data-toggle="tab" onclick="OneClick()">受測者</a></li>
								<li><a href="#university_student" data-toggle="tab" onclick="OneClick1()">施測者</a></li>
								<li><a href="#medical" data-toggle="tab" onclick="OneClick()">評測者</a></li>
								<li><a href="#project_manager" data-toggle="tab" onclick="OneClick()">專案管理員</a></li>
								<li><a href="#project_members" data-toggle="tab" onclick="OneClick2()">專案成員</a></li>
								<li><a href="#application" data-toggle="tab" onclick="OneClick2()">申請者</a></li>
							</ul>
